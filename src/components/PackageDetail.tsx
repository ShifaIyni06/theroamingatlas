      ...
      <div className="glass-surface overflow-hidden">
        ...
        <div className="relative h-64 md:h-80 lg:h-96 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
            ...
            <p className="font-cursive text-xl md:text-2xl text-primary mt-1">& {pkg.subtitle}</p>
          </div>
        </div>
        ...
        <div className="p-6 md:p-10 space-y-10">
          ...
          <div className="grid grid-cols-2 gap-4 md:gap-6">
            ...
            <div className="glass-card p-6 text-center group hover:scale-[1.02] transition-transform">
              ...
              <p className="text-3xl md:text-4xl font-serif text-foreground">₹{pkg.prices.flight.toLocaleString("en-IN")}</p>
              <p className="text-xs text-muted-foreground mt-1">per person</p>
            </div>
          </div>
          ...
          <div className="pt-2">
            <button onClick={() => onBook(pkg)} className="btn-primary w-full text-lg py-4">
              Book This Package — Starting ₹{pkg.prices.train.toLocaleString("en-IN")}
            </button>
          </div>
        </div>
      </div>
